...
<head>
    ...
    <style>
        ...
        body {background: #1E9FFF;background: url(static/images/bg.jpg);}
        ...
        <div class="layui-form login-form">
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" name="account" lay-verify="required|account" placeholder="用户名或者邮箱" autocomplete="off" class="layui-input" value="system">
                </div>
                <div class="layui-form-item">
